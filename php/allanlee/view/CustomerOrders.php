...
class CustomerOrders extends View{
                    ...
                    <div class="panel panel-default sidebar-menu">
                        ...
                        <div class="panel-body">
                            ...
                            <ul class="nav nav-pills nav-stacked">
                                ...
                                <li>
                                    <a href="<?= PROJECT_URL ?>change-password"><i class="fa fa-user"></i> Change password</a>
                                </li>
                                <li>
                                    <a href="<?= PROJECT_URL ?>sign-out"><i class="fa fa-sign-out"></i> Logout</a>
                                </li>
                            </ul>
                        </div>
